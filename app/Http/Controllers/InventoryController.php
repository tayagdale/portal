...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        $inventory = DB::table("inventory_details")
            ->select(array('*', 'suppliers.description as supp', 'inventory_details.item_id as inventory_id', 'items.brand_name as item_brand_name', 'items.qty_1 as item_qty_1', 'items.uom_1 as item_uom_1', 'items.qty_2 as item_qty_2', 'items.uom_2 as item_uom_2', 'unit_code', 'items.generic_name', DB::raw('SUM(inventory_details.qty) AS Iqty'), DB::raw('     CASE
