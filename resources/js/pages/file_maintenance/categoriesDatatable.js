...
class pgCategories {
    ...
    static initDataTables() {
        ...
        jQuery('.js-dataTable-categories').DataTable({
            ...
            columns: [
                ...
                },
                {
                    data: 'id',
                    render: function (data, type, row) {
                        var old_category_name = row['category_name'];
                        return `
                                <div class="text-center">
                                    <div class="btn-group">
                                    <button type="button" onclick="update(${data},'${old_category_name}')" class="btn btn-sm btn-alt-info " data-bs-toggle="tooltip" title="Update Brand">
