...
class pgCustomers {
    ...
    static initDataTables() {
        ...
        jQuery('.js-dataTable-customers').DataTable({
            ajax: '/admin/customers/all',
            columns: [
                {
                    data: 'customer_code',
                },
                ...
                },
                {
                    data: 'id',
                    render: function (data, type, row) {
                        var old_customer_code = row['customer_code'];
                        ...
                        return `
                                <div class="text-center">
                                    <div class="btn-group">
                                    <button type="button" onclick="update(${data},'${old_customer_code}','${old_description}','${old_address}','${old_contact_person}','${old_contact_no}','${old_position}')" class="btn btn-sm btn-alt-info " data-bs-toggle="tooltip" title="Update Brand">
