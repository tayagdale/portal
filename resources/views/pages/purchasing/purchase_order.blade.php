        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                ...
                <div class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" a>
                    ...
                    Add New PO</button> --}}
                    <a class="btn btn-sm btn-primary" href="{{ route('purchase_order_add.create') }}"><i
                            class="fa fa-plus"></i>
                        Add New PO</a>
                </div>
            </div>
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter table-sm js-dataTable-purchase_orders">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>PO No.</th>
