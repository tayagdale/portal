...
@section('js')
    ...
    <!-- Page JS Code -->
    @vite(['resources/js/pages/purchasing/inspectionsDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                <div class="flex-grow-1">
                    <h1 class="h3 fw-bold mb-2">
                        <a href="./admin/inspection.php">Inspection Details</a> > {{ $inspection_number }}
                        ({{ $po_number }})
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-inspection_details">
                            <thead>
                                <tr>
                                    <th>Item Id</th>
                                    <th>Brand Name</th>
