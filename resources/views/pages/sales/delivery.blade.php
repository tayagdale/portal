...
@section('js')
    ...
    <script src="{{ asset('js/pages/sales/deliveryFunctions.js') }}"></script>
    <script type="module">
    ...
    <!-- Page JS Code -->
    @vite(['resources/js/pages/sales/deliveryDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                ...
                <div class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" a>
                    <a href="#" data-bs-toggle="modal" onclick="create()" class="btn btn-sm btn-primary"><i
                            class="fa fa-plus"></i> Add Delivery</a>
                    @include('modals/delivery/modal')
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-sm table-striped table-vcenter js-dataTable-delivery">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>DR No</th>
