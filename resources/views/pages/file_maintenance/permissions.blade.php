...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/permissionFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/permissionsDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-permissions">
                            <thead>
                                <tr>
