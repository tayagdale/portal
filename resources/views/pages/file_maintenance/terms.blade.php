...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/termFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/termsDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-terms">
                            <thead>
                                <tr>
                                    <th>Term</th>
                                    <th>Calendar</th>
