...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/unitFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/unitsDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-units">
                            <thead>
                                <tr>
                                    <th>Unit</th>
                                    <th>Created at</th>
