...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/customerFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/customersDatatable.js'])
@endsection
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-customers">
                            <thead>
                                <tr>
                                    <th>Customer Code</th>
                                    <th>Description</th>
