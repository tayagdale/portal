...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/taxFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/taxesDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-taxes">
                            <thead>
                                <tr>
                                    <th>Code</th>
                                    <th>Rate</th>
