...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/warehouseFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/warehouseDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                ...
                <div class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" a>
                    <a href="#" class="btn btn-sm btn-primary"onclick="create()"><i class="fa fa-plus"></i> Add New
                        Warehouse</a>
                    @include('modals/warehouse/modal')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-warehouse">
                            <thead>
                                <tr>
