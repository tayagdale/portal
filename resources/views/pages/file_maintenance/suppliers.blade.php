...
@section('js')
    ...
    <script src="{{ asset('js/pages/file_maintenance/supplierFunctions.js') }}"></script>



    <!-- Page JS Code -->
    @vite(['resources/js/pages/file_maintenance/suppliersDatatable.js'])
@endsection
        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                ...
                <div class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" a>
                    <a href="#" class="btn btn-sm btn-primary" onclick="create()"><i class="fa fa-user-plus"></i>
                        &nbsp; Add New
                        Supplier</a>
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-suppliers">
                            <thead>
                                <tr>
                                    <th>Supplier Code</th>
                                    <th>Description</th>
