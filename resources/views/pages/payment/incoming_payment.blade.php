...
@section('js')
    ...
    <script src="{{ asset('js/pages/payment/incomingPaymentFunctions.js') }}"></script>
    <script type="module">
    ...
    <!-- Page JS Code -->
    @vite(['resources/js/pages/payment/incomingPaymentDatatable.js'])
@endsection
@section('content')
    <!-- Hero -->
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center pt-4">
                ...
                <div class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" a>
                    <a href="#" data-bs-toggle="modal" onclick="create()" class="btn btn-sm btn-primary"><i
                            class="fa fa-plus"></i> Receive Payment</a>
                    @include('modals/incoming_payment/modal')
            ...
            <div class="block-content">
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-incoming_payment">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>OR No</th>
