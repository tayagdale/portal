                      ...
                      <div class="text-center">
                        <div class="btn-group">
                          <button type="button" onclick="delete_item(${a})" class="btn btn-sm btn-alt-danger " data-bs-toggle="tooltip" title="Remove Item">
                            ...
                            <div class="text-center">
                              <div class="btn-group">
                                <button type="button"  onclick="updateSO('${r}','${n}','${s}','${l}')" class="btn btn-sm btn-alt-info " data-bs-toggle="tooltip" title="Update">
                            ...
                            </div> `}}],pageLength:10,lengthMenu:[[5,10,15,20],[5,10,15,20]],autoWidth:!1,responsive:!0,order:[[1,"desc"]],columnDefs:[{defaultContent:"-",targets:"_all",orderable:!1},{targets:3,render:$.fn.dataTable.render.number(",",".",2,"P")}]}),jQuery(".item_table").DataTable({ajax:`/admin/inventory_details/data/${$("#os_number").val()}`,columns:[{data:"lot_no"},{data:"item_brand_name"},{data:"iQty",render:function(a,e,t){return a/$("#total_os_qty").text().match(/\d+/g).map(Number)[0]}},{data:null,render:function(a,e,t){return'<input type="text" class="form-control qty_to_add" placeholder="Enter qty to add">'}},{data:null,render:function(a,e,t){return'<input type="text" class="form-control custom-input" placeholder="Enter sale price">'}},{data:null,render:function(a,e,t){return'<input type="text" class="form-control add_remarks" placeholder="Enter Remarks">'}},{data:"iID",render:function(a,e,t){var r=t.iID,n=t.item_id,s=t.item_brand_name,l=t.item_unit_id,d=t.iQty,o=t.lot_no,i=t.expiration_date;return`
                      <div class="text-center">
                        <div class="btn-group">
                            <button type="button"  onclick="addToSalesOrder(this,'${r}','${n}','${s}','${l}','${d}','${o}','${i}')" class="btn btn-sm btn-alt-info " data-bs-toggle="tooltip" title="Add to Sales Order">
